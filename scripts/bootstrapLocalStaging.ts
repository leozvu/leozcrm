...
function main(): void {
  ...
  const env = [
    ...
    `LEOZOPS_OPERATOR_TOKEN_SHA256=${sha256(sourceOperatorToken)}`,
    'LEOZOPS_SOURCE_ENGINE_VERSION=egoric_ingestion_v1',
    'LEOZOPS_SOURCE_STALE_AFTER_MS=1800000',
    'LEOZOPS_POLL_REQUEST_TIMEOUT_MS=10000',
    'LEOZOPS_POLL_MAX_RETRIES=2',
    'LEOZOPS_POLL_BASE_DELAY_MS=1000',
    'LEOZOPS_POLL_MAX_DELAY_MS=10000',
    'LEOZOPS_POLL_JITTER_RATIO=0.2',
    'LEOZOPS_POLL_CIRCUIT_FAILURE_THRESHOLD=3',
    'LEOZOPS_POLL_CIRCUIT_OPEN_MS=900000',
    'LEOZOPS_POLL_LEASE_MS=120000',
