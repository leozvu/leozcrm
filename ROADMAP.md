...
### Sprint 2 — 🚧 S2.A T1–T4 Technical Pass (publication pending)
...
authorized S2.A T1–T4 locally; the core passes at `b5f5ede`. T5–T8 and all
external work remain blocked.
Planned contents:
