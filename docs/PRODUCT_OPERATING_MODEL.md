...
The `egoric-readonly` runtime profile is a planned S1.C deliverable. Until it is
implemented and tested, the existing app must not be deployed as the Egoric
LeozOps integration.
