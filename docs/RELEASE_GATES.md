...
| **G5 — Shadow Trust** | Read-only CEO pilot may be released | Independent deployment, production canary, ten business days of read-only shadow, freshness/reliability targets, useful output, no material false claims or workflow regression | **S2.A T1–T8 local/test accepted (`T1–T4 main@5d140a8`, `T5–T8 [PR #13](https://github.com/leozvu/leozcrm/pull/13) at main@1911349`); live PostgreSQL keeps Checkpoint A open, and P1/P2/deployment remain blocked** |
