...
| **G5 — Shadow Trust** | Read-only CEO pilot may be released | Independent deployment, production canary, ten business days of read-only shadow, freshness/reliability targets, useful output, no material false claims or workflow regression | **S2.A T1–T4 technical PASS at `b5f5ede`, publication pending; T5–T8, P1/P2, and deployment remain blocked** |
