...
| **G4 — Local End-to-End** | Sprint 1 may be accepted | Real test snapshot → stored memory → brief; exact reconciliation; no-mutation proof; flag/key revocation drill; CEO acceptance recorded | **Technical PASS at `dc9fb89`; publication and Product Owner acceptance pending** |
